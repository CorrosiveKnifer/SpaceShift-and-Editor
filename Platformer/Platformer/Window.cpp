...
//Default Constructor
Window::Window()
	: m_pBackBuffer(0), m_pSoundBuffer(0), m_pInputHandler(0)
...
//
bool Window::Initialise(BackBuffer& _backBuffer, SoundBuffer& _soundBuffer)
{
	m_pBackBuffer = &_backBuffer;
	m_pSoundBuffer = &_soundBuffer;
...
// GetBackBuffer( )
//
// Description:	returns the back buffer.
//				
// @Param	n/a
//
// @Return	const BackBuffer*	This window's backbuffer.
//
...
// GetSoundBuffer( )
//
// Description:	returns the sound buffer.
//				
// @Param	n/a
//
// @Return	const SoundBuffer*	This window's backbuffer.
//
SoundBuffer* Window::GetSoundBuffer()
{
